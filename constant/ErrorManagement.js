...
const ErrorCodes = {
    ...
    // Java spelled this three ways across its produce blocks, one of them "Kakfka Error:".
    // produceKafka sends this one at every call site; only the code was ever load-bearing.
